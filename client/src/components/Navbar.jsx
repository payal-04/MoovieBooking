...
const Navbar = () => {
  return (
    ...
    justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      max-md:text-lg z-50 flex max-md:flex-col md:flex-row items-center max-md:justify-center
      gap-8 min-md:px-8 py-3 max-md:h-screen min-md:rounded-full backdrop-blur bg-black/70 md:bg-white/10 md:border
      border-gray-300/20 overflow-hidden transition-[width] duration-300'>
      <XIcon className='md:hidden absoulte top-6 right-6 w-6 h-6 cursor-pointer' />
      <Link to='/'>Home</Link>
