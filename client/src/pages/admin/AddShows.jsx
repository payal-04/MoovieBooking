...
useEffect(()=>{
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <p className='mt-10 text-lg font-medium'>Current Screening Movies</p>
      ...
      <div className='inline-flex items-center gap-2 border border-gray-600 px-2 py-2 rounded-md'>
        ...
        <input min={0} type="number" value={showPrice} onChange={(e)=>
         setShowPrice(e.target.value)} placeholder='Enter Show Price Here'
            ...
            {times.map((time)=>(
              ...
              flex items-center rounded'>
                 ...
                 <DeleteIcon onClick={()=> handleRemoveTime(date,time)} width={15}
                  className='ml-2 text-red-500 hover:text-red-700 corsor-pointer'/>
              </div>
            ))}
          </div>
          </li>
